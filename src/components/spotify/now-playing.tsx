...
export function NowPlaying() {
  ...
  return (
    <div className={`relative w-full z-30 transition-[height] duration-300 ease-spring ${data.isPlaying ? "h-[84px]" : "h-[50px]"}`}>
      <motion.div
        transition={{
          type: "spring",
          bounce: 0.35,
                ...
                {data.albumImageUrl && (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-2.5 h-2.5 rounded-full bg-background/80 z-10" />
                    </div>
