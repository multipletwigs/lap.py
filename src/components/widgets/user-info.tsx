        ...
        <div className="lg:hidden">
          <DropdownMenu>
            <DropdownMenuTrigger className="outline-none">
              <div className="inline-flex items-center justify-center rounded-lg w-9 h-9 bg-background/60 border border-border/50 text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors">
  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        <DropdownMenu>
          <DropdownMenuTrigger className="outline-none">
            <div className="inline-flex items-center justify-center rounded-lg w-9 h-9 bg-background/60 border border-border/50 text-foreground hover:bg-accent hover:text-accent-foreground transition-colors animate-in fade-in slide-in-from-right-2 duration-500 delay-300">
          ...
          <DropdownMenuContent align="end" className="w-64">
            <div className="p-2">
              ...
              <Link
                href={data.songUrl || "#"}
                target="_blank"
                className="text-[10px] text-green-600 hover:underline mt-2 block"
              >
                Open in Spotify ↗
              </Link>
            </div>
