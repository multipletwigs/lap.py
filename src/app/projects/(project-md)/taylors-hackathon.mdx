...
description={"This article includes the lessons I've learnt during this hackathon, both technical and design-wise. Feel free to skip around!"}
icon={<RocketIcon/>}/>


<img src="/projects/taylors-hackathon/resumetry-demo.gif" alt="Resumetry Demo"/>

<br/>
_We won second place - Thank you [Xin Le](https://www.linkedin.com/in/xin-le-lam), [Roy](https://www.linkedin.com/in/roy-ng-55ab58207) and Dylan for being such amazing teammates! 🎉 Here's the demo of [Resumetry](https://resumetry.vercel.app), along with its [GitHub Repo](https://github.com/multipletwigs/resumetry)!_
